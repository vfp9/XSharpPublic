...
namespace Microsoft.VisualStudio.Project
{
    ...
    public class FileNode : HierarchyNode
    {
        ...
        static FileNode()
        {
            ...
            AddExtension(".py", KnownMonikers.PYFile);
            AddExtension(".rb", KnownMonikers.RBFileNode);
            ...
            AddExtension(".ts", KnownMonikers.TSSourceFile);
            AddExtension(".txt", KnownMonikers.TextFile);
            AddExtension(".vb", KnownMonikers.VBSourceFile);
                    ...
                    case VsCommands2K.RUNCUSTOMTOOL:
                        {
                            ...
                            {
                                Logger.Exception(e, "Running Custom Tool failed");
                                throw;
                            }
                        }
                }
        ...
        protected override int AfterSaveItemAs(IntPtr docData, string newFilePath)
        {
            ...
            {
                Logger.Exception(e, "AfterSaveItemAs");
